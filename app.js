...
var incompleteTaskHolder=document.getElementById("tasks-list");//ul of #tasks-list
var completedTasksHolder=document.getElementById("tasks_completed");//tasks_completed
...
var editTask=function(){
    ...
    var containsClass=listItem.classList.contains("button_edit");
    ...
    listItem.classList.toggle("button_edit");
};
